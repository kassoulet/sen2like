...
Run with:  PYTHONPATH=chime python -m pytest chime4sen2like/tests
       or:  PYTHONPATH=chime4sen2like/chime python chime4sen2like/tests/test_spectral_aggregation.py
"""
import os
import sys
...
sys.path.insert(0, os.path.join(os.path.dirname(__file__), "..", "chime"))
